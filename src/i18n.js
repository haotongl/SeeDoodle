...
const DICT = {
  zh: {
    'FILL TO 32 WITH BOTS': '用人机补满 32 人',
    'Campus-inspired layout - 480 x 360 m - expanded campus and lakeside': '校园实景参考 · 480 × 360 米 · 扩展教学区与湖岸',
    'BASIC LIBRARY': '基础图书馆',
    'EAST 3': '东三教学楼',
    'EAST 5': '东五教学楼',
    'EAST 6 / EAST 7': '东六 / 东七教学楼',
    'WEST LAKE WALK': '西侧湖岸步道',
    'team battles, demolition or survival · up to 32 players': '团队竞技、爆破或生存 · 最多 32 人',
    // ---- main menu ----
    ...
    'PLAY ONLINE': '联机游戏',
    'free for all or squad survival · up to 32 players': '自由混战或组队生存 · 最多 32 人',
    'best score: {}': '最高分：{}',
    'map': '地图',
    'checkpoints': '存档点',
    'WAVE {}': '第 {} 波',
    ...
    'TIMES SQUARE': '时代广场 · 纽约',
    'SUMMER PALACE': '颐和园 · 万寿山',
    'OLD SUMMER PALACE': '圆明园 · 西洋楼',
    'THE GREAT WALL': '长城 · 慕田峪',
    'LOMBARD STREET': '九曲花街 · 旧金山',
    'Summer Palace': '颐和园',
    'Old Summer Palace': '圆明园',
    'The Great Wall': '长城',
    'Lombard Street': 'Lombard Street · 九曲花街',
    'Longevity Hill, painted corridors and Kunming Lake': '万寿山、彩绘长廊与昆明湖畔',
    'Great Fountain ruins, carved stone and garden paths': '大水法遗址、雕花断柱与园林小径',
    'Mutianyu watchtowers, ridge stairs and mountain trails': '慕田峪敌楼、城墙阶梯与山腰步道',
    'eight hairpin turns, hillside gardens and bay views': '八道回头弯、坡地花园与海湾远景',
    'Longevity Hill and lakeshore - routes adapted for play': '万寿山与昆明湖岸 · 游线经对战适配',
    'Western Mansions ruins - garden routes adapted for play': '西洋楼遗址区 · 园路经对战适配',
    'Mutianyu-inspired ridge - linked wall and mountain routes': '取景慕田峪山脊 · 城墙与山路互通',
    'Hyde to Leavenworth - eight bends and a 34 m descent': '海德街至莱文沃思街 · 八道弯与 34 米高差',
    'Hyde Street': '海德街',
    'Leavenworth Street': '莱文沃思街',
    'Eight Hairpin Turns': '连续回头弯',
    'Garden Courtyard': '住宅庭院',
    'Terrace Garden': '台地花园',
    'Long Corridor': '长廊',
    'Paiyun Courtyard': '排云殿院',
    'Tower of Buddhist Incense': '佛香阁',
    'Foxiangge': '佛香阁',
    'Kunming Lakeshore': '昆明湖岸',
    'Kunming Lake': '昆明湖',
    'West Garden': '西侧园林',
    'East Garden': '东侧园林',
    'West Watchtower': '西侧敌楼',
    'Ridge Watchtower': '山脊敌楼',
    'Mutianyu Pass': '慕田峪关',
    'High Watchtower': '高台敌楼',
    'East Watchtower': '东侧敌楼',
    'Mountain Trail': '山腰步道',
    'Great Wall Ridge': '长城山脊',
    'YUANYINGGUAN RUINS': '远瀛观遗址',
    'DASHUIFA': '大水法',
    'GRAND FOUNTAIN BASINS': '喷泉遗址',
    'GUANSHUIFA': '观水法',
    'WEST RUINS GARDEN': '西侧遗址园',
    'EAST STONE GARDEN': '东侧石园',
    'SOUTH GARDEN WALK': '南侧园路',
    'Broadway lights, red steps and the city crossroads': '百老汇广告屏、红色阶梯与城市十字路口',
    'DUFFY SQUARE': '达菲广场',
    'BROADWAY PLAZA': '百老汇步行广场',
    'SEVENTH AVENUE': '第七大道',
    'ONE TIMES SQUARE': '时代广场一号',
    'MARRIOTT MARQUIS': '万豪侯爵酒店',
    'ONE ASTOR PLAZA': '阿斯特广场一号',
    'PARAMOUNT': '派拉蒙大厦',
    'THEATER PASSAGE': '剧院通道',
    'CITY ARCADE': '城市商廊',
    '47TH STREET': '第 47 街',
    '42ND STREET': '第 42 街',
    'New York at dusk - 100 x 220 m - Broadway, Duffy Square and landmark towers': '纽约暮色 · 100 × 220 米 · 百老汇、达菲广场与地标楼群',
    ...
    '{}: map / score': '{}：地图 / 战绩',
    'Tactical map': '战术地图',
    'Minimap - you and teammates': '小地图 - 自己与队友',
    'Minimap - spectating teammate': '小地图 - 正在观战队友',
    'N': '北',
