...
const DICT = {
  zh: {
    ...
    'full charge pulls pin automatically; release to throw': '蓄满自动拉环 · 松开投掷',
    'full charge pulls pin; release to throw - {}: cancel': '蓄满自动拉环 · 松开投掷 · {} 取消',
    '{}: drop - release to throw': '{} 丢下 · 松开投掷',
    'RMB / V': '右键 / V',
    'LMB / G': '左键 / G',
    'hold <b>{}</b> to charge; release to throw': '按住 <b>{}</b> 蓄力，松开投掷',
    'hold to charge - full charge pulls pin; right click or V cancels': '按住蓄力 · 蓄满自动拉环，右键或 V 取消',
    'hold LMB / G; full charge pulls pin - release to throw, V cancels': '按住左键 / G，蓄满自动拉环 · 松开投掷，V 取消',
    'in grenades only: hold to charge, release to throw': '仅限手雷模式：按住蓄力，松开投掷',
    'Full charge': '蓄力满',
    'automatically pulls the pin after 1.1 seconds; the fuse lasts 7 seconds': '按住 1.1 秒后自动拉环，7 秒后爆炸，握在手中也会炸',
